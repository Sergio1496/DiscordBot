...
class Notify_(commands.Cog):
    ...
    async def notifys(self):
        ...
        if notify_mode == 'Specified':
            ...
            try:
                ...
                print(f'Error con la notificación - {e}')
            ...
            try:
                ...
                for user in user_data:
                    ...
                    embed = discord.Embed(color=0xfd4554)
                    embed.description = f"Tienda diaria para: **{data_['IGN']}** | Restante {format_dt((datetime.utcnow() + timedelta(seconds=skin_list['duration'])), 'R')}"
    ...
    async def before_daily_send(self):
        ...
        print('Chequeando nuevas skins de la tienda para la notificación...')
